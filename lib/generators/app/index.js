...
import { install, concatList, loadDeps, copyDir, js2ts } from '../../util/index.js';

export default class BaseGenerator extends Generator {
  _copyDir(src, dest, transform) {
    copyDir(this, src, dest, this.state, transform);
  }
  ...
  rootFiles() {
    ...
    const pkg = {
      ...
      scripts: {
        ...
        lint: `prettier --ignore-path .gitignore --check --plugin-search-dir=. . && eslint --ext ${ext.join(',')} .`,
        ci: 'run-s lint',
      },
    };
    pkg.dependencies = {
